...
void updateBaseActuator() {
  ...
  baseCurrentPos = (byte)constrain(map((int)basePotValue, CAL_BASE_POT_MIN, CAL_BASE_POT_MAX, 0, 255), 0, 255);
...
void updateShoulderActuator() {
  ...
  shoulderCurrentPos = (byte)constrain(map((int)shoulderPotValue, CAL_SHOULDER_POT_MIN, CAL_SHOULDER_POT_MAX, 0, 255), 0, 255);
...
*/
  ...
  elbowCurrentPos = (byte)constrain(map((int)elbowPotValue, CAL_ELBOW_POT_MIN, CAL_ELBOW_POT_MAX, 0, 255), 0, 255);
